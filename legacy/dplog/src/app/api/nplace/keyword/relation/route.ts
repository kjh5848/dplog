...
export async function GET(request: Request): Promise<NextResponse<ClientApiResponse<KeywordToolListResponse>>> {
  const result = await NplaceKeywordService.getRelationList(request);
