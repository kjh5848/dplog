/**
 * [Role]   개인정보처리방침 페이지 (마케팅 동의 포함)
 * [Input]  -
 * [Output] 카카오 싱크, 마케팅 활용, 법령 링크를 포함한 개인정보처리방침 전체 화면 렌더링
 * [NOTE]   Static Page · 2025-07-22 시행 버전
 */
                ...
                <section>
                  ...
                  <ul className="list-disc list-inside space-y-2 ml-4 bg-gray-50 p-4 rounded-lg">
                    ...
                    <li><strong>마케팅·광고성 정보 전송(별도 선택 동의자 한정)</strong> → 
                      <a href="/maketing" className="text-blue-600 hover:text-blue-800 underline">마케팅 정보활용 동의</a> 페이지 참조
                    </li>
                  </ul>
                </section>
                      ...
                      <tbody>
                        ...
                        <tr className="bg-yellow-50">
                          ...
                          <td className="border border-gray-300 px-4 py-2">
                            <a href="/maketing" className="text-blue-600 hover:text-blue-800 underline">마케팅 정보활용 동의</a> 체크박스
                          </td>
                ...
                <section>
                  ...
                  <div className="bg-yellow-50 p-6 rounded-lg border-l-4 border-yellow-400">
                    <p className="text-sm text-gray-700 mb-4">
                      ...
                      <a href="/maketing" className="text-blue-600 hover:text-blue-800 underline font-semibold">마케팅 정보활용 동의</a> 
                      페이지에서 확인할 수 있습니다.
                    </p>
