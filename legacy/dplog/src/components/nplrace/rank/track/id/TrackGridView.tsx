...
export default function TrackGridView(
  { trackList, gridColumns: initialGridColumns = 4, hideControls = false, onItemClick, getRankString, selectedTrackData }: TrackGridViewProps) {
        ...
        >
          {filteredTrackList.map((track, index) => {
            ...
            return (
              <div
                key={index}
                className={`flex flex-col rounded-lg border p-2 cursor-pointer hover:shadow-md transition-all duration-200 transform hover:scale-105 ${
                  isSelected 
              ...
              >
                ...
                <div className="mt-1 text-center">
                  <span className="text-xs text-blue-500 opacity-75">클릭하여 순위비교</span>
                </div> */}
      ...
      >
        {filteredTrackList.map((track, index) => {
          ...
          return (
            <div
              key={index}
              className={`group relative rounded-lg border p-4 shadow-sm transition-all hover:shadow-lg cursor-pointer ${
                isSelected 
                  ? 'border-blue-500 bg-blue-50' 
            ...
            >
              ...
              <div className="mb-4 flex items-center justify-between">
                <div className="flex items-center space-x-2">
                  ...
                  {!getRankString && <span className="text-sm text-gray-500">위</span>}
                  {rankChange.text && (
                    <div
