...
@NoArgsConstructor
@AllArgsConstructor
public class ResNstoreKeywordGetNsearchadKeywordstoolDTOApiV1 {

    private List<KeywordTool> keywordToolList;

    public static ResNstoreKeywordGetNsearchadKeywordstoolDTOApiV1 of(
            List<ResNsearchadKeywordstoolDTO.Keyword> resNsearchadKeywordstoolKeywordList
    ) {
        return ResNstoreKeywordGetNsearchadKeywordstoolDTOApiV1.builder()
