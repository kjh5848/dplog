...
public class ReqNstoreRankPostTrackDTOApiV1 {
    ...
    @Valid
    @NotNull(message = "nstoreRankTrackInfo를 입력하세요.")
    private NstoreRankTrackInfo nstoreRankTrackInfo;

    public ReqNomadscrapNstoreRankPostTrackDTO toNomadscrapDTO() {
        return ReqNomadscrapNstoreRankPostTrackDTO.builder()
                .nstoreRankTrackInfo(
                        ReqNomadscrapNstoreRankPostTrackDTO.NstoreRankTrackInfo.builder()
                                .keyword(nstoreRankTrackInfo.getKeyword())
                                .mid(nstoreRankTrackInfo.getMid())
                                .productId(nstoreRankTrackInfo.getProductId())
                                .build()
                )
                .build();
    }
