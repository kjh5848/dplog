...
@NoArgsConstructor
@AllArgsConstructor
public class ResNstoreRankPostProductTableDTOApiV1 {

    private List<NstoreRankProduct> nstoreRankProductList;

    public static ResNstoreRankPostProductTableDTOApiV1 of(
        ...
        return ResNstoreRankPostProductTableDTOApiV1.builder()
