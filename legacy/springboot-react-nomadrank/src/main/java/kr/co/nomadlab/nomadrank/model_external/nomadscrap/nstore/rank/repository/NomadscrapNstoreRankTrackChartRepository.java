...
public class NomadscrapNstoreRankTrackChartRepository {
    ...
    public ResNomadscrapNstoreRankPostTrackChartDTO postTrackChart(ReqNomadscrapNstoreRankPostTrackChartDTO reqDto) {
        final UriComponents uriComponents = UriComponentsBuilder
                .fromHttpUrl("http://%s/v1/nstore/rank/track/chart".formatted(nomadscrapServerIp))
                .queryParam("apiKey", nomadscrapServerApiKey)
                .build();
        ResponseEntity<ResNomadscrapNstoreRankPostTrackChartDTO> responseEntity = UtilFunction.getWebClientAutoRedirect("json")
                .post()
                .uri(uriComponents.toUriString())
                .bodyValue(reqDto)
                .exchangeToMono(clientResponse -> clientResponse.toEntity(ResNomadscrapNstoreRankPostTrackChartDTO.class))
                .block();
