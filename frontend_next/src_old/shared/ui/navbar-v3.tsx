...
export const DPlogLogo = () => (
  <div className="flex items-center gap-2 text-blue-600 dark:text-blue-400 font-extrabold text-xl tracking-tighter">
    <span className="material-icons-round text-2xl">hub</span>
    <span>D-PLOG</span>
  </div>
);

export function NavbarV3({ isVisible = true }: { isVisible?: boolean }) {
	...
	return (
		<header
			className={cn(
				'sticky top-0 z-50 mx-auto w-full max-w-5xl border-b border-transparent lg:rounded-full lg:border lg:transition-all lg:ease-out',
			...
			>
				...
				<div className="hidden items-center gap-4 lg:flex">
					...
					<div className="flex items-center gap-2">
						<button className="px-4 py-2 text-sm font-semibold text-slate-700 dark:text-slate-300 hover:text-blue-600 transition-colors">로그인</button>
