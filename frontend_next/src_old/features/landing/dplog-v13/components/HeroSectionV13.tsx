...
export const HeroSectionV13 = ({ onComplete }: HeroSectionV13Props) => {
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="bg-blue-600 hover:bg-blue-700 text-white px-10 py-4 rounded-full font-bold flex items-center justify-center gap-2 transition-all shadow-xl shadow-blue-500/20"
            >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 px-10 py-4 rounded-full font-bold hover:bg-slate-50 dark:hover:bg-slate-700 transition-all text-slate-700 dark:text-slate-200"
            >
              서비스 소개서 다운로드
            </motion.button>
          </div>
