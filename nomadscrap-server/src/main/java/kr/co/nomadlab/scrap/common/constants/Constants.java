package kr.co.nomadlab.scrap.common.constants;
...
public class Constants {
    ...
    public static class Regex {
        ...
        public static final String NPLACE_ENTRY_SHOP_URL = "^https://map\\.naver\\.com/p/entry/place/[0-9]+$";
        public static final String NPLACE_SEARCH_SHOP_URL = "^https://map\\.naver\\.com/p/search/[^/]+/place/[0-9]+$";
        public static final String NPLACE_MOBILE_SHOP_URL = "^https://m\\.place\\.naver\\.com/[^/]+/[0-9]+";
