...
@NoArgsConstructor
@AllArgsConstructor
public class ResNplaceRankPostTrackInfoDTOApiV1 {

    private List<NplaceRankTrackInfo> nplaceRankTrackInfoList;

    public static ResNplaceRankPostTrackInfoDTOApiV1 of(List<NplaceRankTrackInfoEntity> nplaceRankTrackInfoEntityList) {
        return ResNplaceRankPostTrackInfoDTOApiV1.builder()
